	...
	<div class="more-options">
		...
		<div class="advanced options">
			<div class="row short download-limit">
				<?php echo $this->app->html->_('control.text', $this->getControlName('access_level'), $this->get('access_level'), 'size="6" maxlength="255" title="'.JText::_('Access level').'" placeholder="'.JText::_('Access Level').'"'); ?>
			</div>
			<div class="row short download-limit">
