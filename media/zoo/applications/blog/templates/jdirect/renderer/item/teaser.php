...
<div class="pos-media teaser align-<?php echo $align; ?>"><?php echo $this->renderPosition('media', array('style' => 'block')); ?></div>
<?php endif; ?>
...
<section class="rightcontent">
	...
	<div class="content clearfix">
		...
		<div class="pos-content"><?php echo strip_tags($this->renderPosition('content', array('style' => 'block'))); ?></div>
		<?php endif; ?>
	</div>
